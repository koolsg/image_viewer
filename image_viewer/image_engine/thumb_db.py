"""Small wrapper helpers for accessing the thumbnail DB.

This file centralizes common SQLite access patterns used by fs_model and
other components so we avoid duplicate SQL management and connection code.
"""
